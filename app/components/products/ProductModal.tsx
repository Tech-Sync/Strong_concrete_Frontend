...
import { Firm, Product } from "@/types/types";
...
export default function ProductModal({ modal, setModal, productInitials, setFirmInitials, }: firmModalProps) {
  const emptyProduct = {
    name: "",
    address: "",
    phoneNo: "",
  ...
  return (
    <div>
      <button
        onClick={() => {
          setModal(true), setFirmInitials(emptyProduct);
        }}
