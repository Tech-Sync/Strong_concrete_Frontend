    ...
    return (
        <div>
            <div className="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                <button type="button" className="btn btn-info gap-2" onClick={() => window.location.href = 'mailto:destek@example.com'}>
                ...
                <button type="button" className="btn btn-success gap-2" onClick={downloadFile}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5">
                        <path
                            opacity="0.5"
